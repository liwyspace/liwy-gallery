	...
	rearrange: function (centerIndex) {
		var imgsArrangeArr = this.state.imgsArrangeArr,
	        ...
	        vPosRangeX = vPosRange.x,
	       	...
	       	imgsArrangeTopArr = [], //上部区域图片数组
	        topImgNum = Math.floor(Math.random() * 2), //上部区域图片个数,取一个或零个
	        topImgSpliceIndex = 0, //上部区域图片数组开始坐标

	        imgsArrangeCenterArr = imgsArrangeArr.splice(centerIndex, 1);//从图片数组中取出居中的图片
